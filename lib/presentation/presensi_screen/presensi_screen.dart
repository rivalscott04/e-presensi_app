import '../presensi_screen/widgets/listmasuk_one2_item_widget.dart';
import '../presensi_screen/widgets/listrectanglethree2_item_widget.dart';
...
class PresensiScreen extends GetWidget<PresensiController> {
  @override
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          fontStyle: ButtonFontStyle.InterBold16WhiteA701,
                        ),
                      ],
                    ),
                  ),
                                                  ...
                                                  child: Obx(
                                                    () => ListView.separated(
                                                      ...
                                                      itemCount: controller
                                                          .presensiModelObj
                                                          .value
                                                          .listmasukOne2ItemList
                                                          .length,
                                                      itemBuilder:
                                                          (context, index) {
                                                        ListmasukOne2ItemModel
                                                            model = controller
                                                                .presensiModelObj
                                                                .value
                                                                .listmasukOne2ItemList[index];
                                                        return ListmasukOne2ItemWidget(
                                                          model,
                                                        );
                                                      },
                                                    ),
                ...
                Container(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      itemCount: controller.presensiModelObj.value
                          .listrectanglethree2ItemList.length,
                      itemBuilder: (context, index) {
                        Listrectanglethree2ItemModel model = controller
                            .presensiModelObj
                            .value
                            .listrectanglethree2ItemList[index];
                        return Listrectanglethree2ItemWidget(
                          model,
                        );
                      },
                    ),
