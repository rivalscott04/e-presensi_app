...
class PresensiTwoItemWidget extends StatelessWidget {
  PresensiTwoItemWidget(this.presensiTwoItemModelObj);

  PresensiTwoItemModel presensiTwoItemModelObj;

  var controller = Get.find<PresensiTwoController>();
