...
class ListmasukOne1ItemWidget extends StatelessWidget {
  ListmasukOne1ItemWidget(this.listmasukOne1ItemModelObj);

  ListmasukOne1ItemModel listmasukOne1ItemModelObj;
