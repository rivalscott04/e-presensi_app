...
class ListmasukOneItemWidget extends StatelessWidget {
  ListmasukOneItemWidget(this.listmasukOneItemModelObj);

  ListmasukOneItemModel listmasukOneItemModelObj;
